...
namespace Arcana_Compiler.ArcanaParser {
    public class ASTPrinter {
        ...
        private IEnumerable<ASTNode> GetChildren(ASTNode node) {
            return node switch {
                ProgramNode programNode => programNode.Imports.Cast<ASTNode>().Concat(programNode.Declarations),
                ...
                NamespaceDeclarationNode namespaceNode => namespaceNode.ClassDeclarations,
